...
<form id="registerInfo" action="/access/registered" style="margin-top: 5px">
    <div class="form-group">
        <label for="register-emaill">Email address</label><span id="register-emaill-error" style="color: red;display: none;"></span>
    ...
    <div class="form-group">
        <label for="register-password">Password</label><span id="register-password-error" style="color: red;display: none;"></span>
